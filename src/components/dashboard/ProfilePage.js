      ...
      <div class="w-full bg-green-50 h-screen flex flex-row flex-wrap justify-center ">
        ...
        <div class="w-0 md:w-1/4 lg:w-1/5 h-0 md:h-screen overflow-y-hidden bg-white shadow-lg">
          ...
          <div class="w-full h-screen antialiased flex flex-col hover:cursor-pointer">
            <a
              class="hover:bg-gray-300 bg-gray-200 border-t-2 border-gray-300 p-3 w-full text-xl text-left text-green-600 font-semibold"
              href=""
            >
              <i class="fa fa-comment text-gray-600 text-2xl pr-1 pt-1 float-right" />Messages
            </a>
            <a
              class="hover:bg-gray-300 bg-gray-200 border-gray-300 border-t-2 p-3 w-full text-xl text-left text-gray-600 font-semibold"
              href=""
            >
              <i class="fa fa-cog text-gray-600 text-2xl pr-1 pt-1 float-right" />Settings
            </a>
            <a
              class="hover:bg-gray-300 bg-gray-200 border-gray-300 border-t-2 p-3 w-full text-xl text-left text-gray-600 font-semibold"
              href=""
        ...
        <div class="w-full md:w-3/4 lg:w-4/5 p-5 md:px-12 lg:24 h-full overflow-x-scroll antialiased">
          <div class="bg-white w-full shadow rounded-lg p-5">
            <textarea class="bg-gray-200 w-full rounded-lg shadow border p-2" rows="5" placeholder="Speak your mind" />
            ...
            <div class="w-full flex flex-row flex-wrap mt-3">
              ...
              <div class="w-2/3">
                <button type="button" class="float-right bg-indigo-400 hover:bg-indigo-300 text-white p-2 rounded-lg">
                  Submit
                </button>
              </div>
            </div>
          ...
          <div class="mt-3 flex flex-col">
            <div class="bg-white mt-3">
              ...
              <div class="bg-white p-1 border shadow flex flex-row flex-wrap">
                ...
                <div class="w-1/3 hover:bg-gray-200 border-l-4 border-r- text-center text-xl text-gray-700 font-semibold">
                  Share
                </div>
              ...
              <div class="bg-white border-4 bg-gray-300 border-white rounded-b-lg shadow p-5 text-xl text-gray-700 content-center font-semibold flex flex-row flex-wrap">
                <div class="w-full">
                  <div class="w-full text-left text-xl text-gray-600">@Some Person</div>
                  A Pretty Cool photo from the mountains. Image credit to @danielmirlea on Unsplash. A Pretty Cool photo
                  from the mountains. Image credit to @danielmirlea on Unsplash.
                </div>
              </div>
            </div>
