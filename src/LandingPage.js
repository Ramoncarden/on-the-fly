...
const LandingPage = () => {
  return (
    <div className="bg-indigo-900 relative overflow-hidden h-screen">
      <img
        src="https://www.freepik.com/free-vector/modern-kitchen-interior-background-template-cartoon-dinner-room-with-furniture_2238444.htm#page=1&query=cartoon%20kitchen&position=1"
